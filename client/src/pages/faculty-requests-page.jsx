...
export default function FacultyRequestsPage() {
  ...
  if (!user || user.role !== "faculty") {
    return <DashLayout title="Access Denied" description="Only faculty members can access this page">
      ...
      <Card>
        ...
        <CardContent>
          {requestsLoading ? <div className="flex items-center justify-center py-8">
              ...
              {requests.map((request) => <div key={request.id} className="border rounded-lg p-6 space-y-4">
  ...
  >
                  ...
                  {request.status === "Accepted" && <div className="pt-2">
                      <Button
    size="sm"
    variant="outline"
